...
##longitud_max_ruido = max(len(ruido1), len(ruido2), len(ruido3))
...
##ruido1 = ruido1.astype(np.float64)
...
##ruido2 = ruido2.astype(np.float64)
##ruido3 = np.pad(ruido3, (0, longitud_max_ruido - len(ruido3)))
sample_rate, ruido3 = wav.read("C:\\Users\\sachi\\OneDrive - unimilitar.edu.co\\Sexto semestre\\Lab señales\\Lab 3\\ruidos.wav")
##ruido3 = ruido3.astype(np.float64)
